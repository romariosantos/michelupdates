...
<div class="geral">
		...
		<div class="clear"></div>
			...
			<span class="bread">
				<a href="<?php echo ROOT .'/minhas_receitas_enviadas.php';?>">Minhas Receitas Enviadas</a> 
			</span>
		 
		</div>
			
		<h1 class="titleg-rec italic">Minhas Receitas Enviadas</h1>
...
?>
		...
		<div class="center_mlivro">
			...
			<div class="rec_salvas">
				...
				<?php
					if($qtdMeuLivro > 0){
						echo "<div  class='q14'>Foram encontrada(s): <strong>".$qtdMeuLivro."</strong> receita(s) enviada por você.</div><br />";
					}else{
						echo "<div  class='q14'>Não foram encontrada(s) nenhuma receita aprovada enviada por você.<br /></div><br />";
					}
					while($rowlivro = mysql_fetch_array($sqlTotalRecAguardando)){
							...
							<div class="infs_rs">
								...
								<ul class="opcoes_re">
									<li><a href="#">Receita aprovada</a></li>
									<div class="clear"></div>
								</ul>
								...
								<ul class="opcoes_rs" id="op'.$idReceita.'">
									...
									<li><a href="editar_receitas_enviadas_e_aprovadas.php?id='.$idReceita.'"><i class="ic ic_config"></i> Editar Receita</a></li>
