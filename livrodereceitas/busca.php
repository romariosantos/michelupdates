...
?>
	...
	<div class="geral">
		 ...
		 <div class="breadcrumb">
			...
			<span class="bread">
				<span class="breadsel"><?php echo $_GET['s'];?></span>
			</span>
		</div>
		
		<h1 class="titleg-rec"><?php echo $_GET['s'];?></h1>
		<div class="line">
		...
		<ul class="list-destaques">
			<?php 
				...
				$sqlDestaques = mysql_query("SELECT * FROM receita WHERE nome LIKE '%$termo%' ORDER BY id DESC LIMIT $inicio, $quantidade") or die(mysql_error());
		...
		$sql_2  = mysql_query("SELECT * FROM receita WHERE nome LIKE '%$termo%'");
		...
		echo "<li><a href='".ROOT."/busca.php?s=".$_GET['s']."' >Primeiro</a></li>";

		for($i = $pg-$links; $i <= $pg-1; $i++){
		if($i<=0){
		}else{
		echo "<li><a href='".ROOT."?s=".$_GET['s']."&pg=".$i."' >".$i."</a></li>";
		}
		}
		...
		echo "<li><a href='".ROOT."/busca.php?s=".$_GET['s']."&pg=".$i."' >".$i."</a></li>";
		}
		}

		echo "<li><a href='".ROOT."/busca.php?s=".$_GET['s']."&pg=".$paginas."' >Último</a></li>";
